...
class Ui_CameraSettings(object):
    ...
    def retranslateUi(self, CameraSettings):
        ...
        self.cmb_camera_type.setStatusTip(_translate("CameraSettings", "Select camera type"))
        self.cmb_camera_type.setWhatsThis(_translate("CameraSettings", "Select camera type"))
        self.label_12.setText(_translate("CameraSettings", "Displayed name:"))
        self.le_name.setStatusTip(_translate("CameraSettings", "Under this name camera will be displayed in viewer"))
        self.le_name.setWhatsThis(_translate("CameraSettings", "Under this name camera will be displayed in viewer"))
        ...
        self.le_tango_server.setStatusTip(_translate("CameraSettings", "Camera tango device, e.g. pXX/lmscreen/LM_XX"))
        self.le_tango_server.setWhatsThis(_translate("CameraSettings", "Camera tango device, e.g. pXX/lmscreen/LM_XX"))
